...
#ifdef NAVSWITCH_SWAP
#define NAVSWITCH_WEST_PIO LEDMAT_COL1_PIO
#define NAVSWITCH_EAST_PIO LEDMAT_COL2_PIO
#define NAVSWITCH_SOUTH_PIO LEDMAT_COL4_PIO
#define NAVSWITCH_NORTH_PIO LEDMAT_COL5_PIO
#else
